const people = [
  {
    name: 'Michał Woźniak',
    role: 'Department of Systems and Computer Networks, Wroclaw University of Science and Technology, Poland.',
    imageUrl:
  ...
  },
  {
    ...
    role: 'Center for Imaging Science, Rochester Institute of Technology, USA.',
    imageUrl:
      'https://bartosz-krawczyk.github.io/assets/img/prof_pic.jpg',
    xUrl: '#',
    linkedinUrl: '#',
    researchGateUrl: 'https://www.researchgate.net/profile/Pawel-Ksieniewicz',
    googleScholarUrl: 'https://scholar.google.com/citations?user=YSM30D8AAAAJ&hl=pl&oi=ao'
...
export function Organizers() {
  return (
    <section id='organizers' className="bg-blue-100 py-4">

    <div className="bg-white py-24 sm:py-32 rounded-4xl">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-3xl font-bold tracking-tight text-blue-900 sm:text-4xl">Organizers</h2>
